...
;; Copyright (C) 2001 Juan Le Lahoz Garcú}

;; Filename: wdired.el
;; Author: Juan Le Lahoz Garcú} <juan-leon.lahoz@tecsidel.es>
;; Version: 1.9.2pre3
...
;; From 1.91 to 1.9.2
;;
;; - Ren÷ÜKyllingstad <kyllingstad at users dot sourceforge dot net>
